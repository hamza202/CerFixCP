...
<head>
    <meta charset="utf-8"/>
    <title>CerFix | الدعم الفني</title>
                    ...
                    <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__body">
                            ...
                            <table class="table table-striped- table-bordered table-hover table-checkable how-work-table"
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>حمزة خميس ابو عيطة</td>
                                    <td>
                                        <span class="kt-badge kt-badge--success kt-badge--dot"></span>
                                        <span class="kt-font-bold kt-font-success">جديدة</span>
                                    </td>
                                    <td>
                                        <a href="support-details.php" class="btn btn-outline-secondary btn-icon btn-sm mx-md-0 mx-1" data-container="body" data-toggle="kt-tooltip" data-placement="top" title="" data-original-title="تفاصيل">
